                                    ...
                                    match &mut revision_builder.text {
                                        ...
                                        _ => {
                                            revision_builder.text =
                                                Some(self::Text::Normal(text.into_owned()))
                                        }
                                    }
                                }
                            }
